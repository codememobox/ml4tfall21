...
class QLearner(object):  		  	   		   	 		  		  		    	 		 		   		 		  
    ...
    def query(self, s_prime, r):  		  	   		   	 		  		  		    	 		 		   		 		  
        ...
        self.Q_table[self.s,self.a] = self.update_Q(self.s, self.a, s_prime, r)
        ...
        if self.dyna > 0:
            ...
            self.hal_exp.append([self.s,self.a,s_prime,r])
            for i in range(self.dyna):
                update_value = self.hal_exp[rand.randint(0,len(self.hal_exp)-1)]
                self.Q_table[update_value[0],update_value[1]] = self.update_Q(update_value[0],update_value[1],update_value[2],update_value[3])
